...
">
     ...
     <list-car :autos="autos" :not_found="no_encontrado" @triggerFromChild="triggerChildRecived"></list-car> 
    </div>
</template>
<script>
...
//import  ListCar  from "./ListCarAuction";
...
export default {
  ...
  methods: {
    ...
    SendFilter() {
     this.autos=[];
      axios
        .get(buildURL("URL_API_SUBASTA", "showroom"), {
          params: {
