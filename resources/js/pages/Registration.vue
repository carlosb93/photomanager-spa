  ...
  <card style="border-bottom: 3px inset rgb(253, 185, 19); border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
      <el-tabs v-model="selectName" @tab-click="handleClick">
        <el-tab-pane label="Persona Fisica" name="tab1">
           <register-profile-form-fisica v-if="selection===0" :user="user" :model="model">
      </register-profile-form-fisica>
        </el-tab-pane>
        <el-tab-pane label="Persona Moral" name="tab2">
          <register-profile-form-moral v-if="selection===1" :user="user" :model="model">
      </register-profile-form-moral>
        </el-tab-pane>
      </el-tabs>
  </card>
...
<script>
  import RegistreProfileFormFisica from './Profile/RegistreProfileFormFisica';
  import RegistreProfileFormMoral from './Profile/RegistreProfileFormMoral';
...
function buildURL(api, resource = "") {
  ...
  export default {
    components: {
      RegistreProfileFormFisica,
      RegistreProfileFormMoral,
      UserCard,
