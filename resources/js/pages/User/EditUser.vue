<template>
 ...
 <!-- formulario 2 -->
    ...
    <el-form v-if="active===3" ref="form3" :model="form4" label-width="90px">
      ...
      <div class="row" style="margin-top: 100px;">
        ...
        <div class="col-md-4 px-md-1">
          <label>
            <span class="required">*</span> Asignar Rol
          </label>
          <select class="form-control" v-model="RoleSelected" @change="fetchRoles">
      ...
      <div class="row">
        <div class="col-md-6 px-md-1">
          <base-button slot="footer" type="default" simple @click="back">Atras</base-button>
          <base-button slot="footer" type="success" :disabled="isProcessing" @click="sendValidator">Aprobar</base-button>
        </div>
        <div class="col-md-3 px-md-1">
          <base-button slot="footer" type="danger" fill :disabled="isProcessing" @click="sendValidatordisable">Cancelar</base-button>
        </div>
      </div>
    </el-form>
  </card>
...
this.errors_validation.push("Debe especificar un rol para el usuario.");
 ...
 axios.get(buildURL("URL_API_SUBASTA", "fetchuser/" + this.$route.params.id))
        ...
        nombretipodocidentificacion: res.data[0].userpersona[0].personas[0].doc_idem[0].nombretipodocidentificacion,
