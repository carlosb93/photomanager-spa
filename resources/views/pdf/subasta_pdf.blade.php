...
<div class="card" >
    ...
    <div class="card-body collapse show" style="margin-top:25px; padding-bottom: 2px">
        <div class="table-responsive">
            <table class="table product-overview" cellspacing="0" style="margin-top:25px; border-color: #000;width: 100%; border-top: 0px; font-size: 0.8em; border:2px">
                <tr>
                    <td  class="heading-table" colspan="2">
                        ...
                        <td  class="heading-table" colspan="2">
                        <a > ${{ number_format($subasta->puja_actual,2).' | '. $precio_venta  }}</a>
                        </td>
                    </tr>
                <tr>
                    <td  class="heading-table" colspan="2">
